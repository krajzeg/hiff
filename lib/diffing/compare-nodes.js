...
function compareNodes($n1, $n2, options) {
  ...
  function getLocalTagChange($n1, $n2) {
    ...
    var attributesDiffer = _.some(allAttributes, function (attribute) {
  ...
  function textNodesShouldBeIgnored($n1, $n2, ignoredParents) {
    ...
    return _.some(ignoredParents, function(selector) {
  ...
  function isIgnored($node) {
    ...
    return _.some(options.ignore, function(selector) {
